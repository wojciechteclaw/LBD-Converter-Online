...
//     var assetsPath: string | undefined;
//     if (process.env.NODE_ENV === "development") {
//         assetsPath = process.env.REACT_APP_WORKERS_PATH;
//     } else {
//         assetsPath = process.env.REACT_APP_WORKERS_PATH;
//     }
//     if (!assetsPath) {
//         assetsPath = "../../assets/ifcjs/";
//     }
